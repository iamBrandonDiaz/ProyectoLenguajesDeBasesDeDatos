...
BEGIN
    ...
    INSERT INTO auditoria_pedidos (pedido_id, usuario_bd, fecha_hora, usuario_so, ip_maquina, nombre_maquina)
    VALUES (:NEW.id_pedido, USER, SYSDATE, v_usuario_so, v_ip_maquina, v_nombre_maquina);
END;
...
FOR EACH ROW
BEGIN
    RAISE_APPLICATION_ERROR(-20002, 'No se permite la eliminación de facturas.');
END;
